...
import { ClockArrowUp, Download, FileSpreadsheet, Funnel, History, SquareMinus } from "lucide-react";
...
export default function OrderHistoryTable() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const data = await SupplyOrderService.getAllSupply();
                const ordersHistory = data.filter((i: SupplyOrder) => ['APPROVED', 'DELIVERED', 'REJECTED'].includes(i.status));
        ...
        <section className="w-full py-4 px-2">
            ...
            <div className="flex items-center gap-2">
                <Image
                    ...
                    height={40}
                />
                <div className="text-xl font-semibold">Supply Order History</div>
                <Image
            ...
            <div className="flex items-center mt-2">
                ...
                <div className="ms-auto flex gap-2">
                    ...
                    <Button className="!bg-darkorange text-light shadow-xs hover:opacity-90">
                        <ClockArrowUp />
                        <Link href="/admin/inventory/order-request">Pending Requests</Link>
                    </Button>
                </div>
            </div>
